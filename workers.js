...
export default {
    async fetch(request, env, ctx) {
        ...
        // /admin/zerotrust 路径 - Zero Trust 登录页
        if (path === '/admin/zerotrust') {
            return serveStaticFile('/admin/zerotrust.html', env);
        }
...
function zerotrustLogin() {
    // 跳转到 Zero Trust 登录页面
    window.location.href = "/admin/zerotrust";
}
